...
import { useManagerSalesReportQuery } from "../../redux/api/saleReportApi/saleReportApi";
...
const MSaleReport = () => {
  ...
  const { data: sales } = useManagerSalesReportQuery(queryData);
